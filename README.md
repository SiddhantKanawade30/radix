...
Radix (referring to a "root" in latin) is a secure, Hierarchical Deterministic (HD) cryptocurrency wallet application. It enables users to generate new 12-word recovery phrases or import existing ones to derive production-ready Solana and Ethereum wallet keys.
